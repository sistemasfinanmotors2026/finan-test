...
export default function ConocenosPage() {
  return (
    <main className="flex-1 bg-white text-gray-900 px-4 py-12 md:px-10 lg:px-20">
      ...
      <section className="max-w-6xl mx-auto py-16">
        <h1 className="text-3xl font-bold text-center mb-8">Nuestra Misión y Visión</h1>
      ...
      <footer className="border-t border-gray-200 pt-8 text-center text-sm text-gray-500">
        © {new Date().getFullYear()} Finan S.A. Todos los derechos reservados.
      </footer>
    </main>
  );
}
